...
public class Adapter_FoodWeLoveFood extends RecyclerView.Adapter {
    private View view;
    private FragmentManager fragmentManager;
    private List<WeLove> list;
    private int lastPosition = -1;

    public Adapter_FoodWeLoveFood(View view, FragmentManager fragmentManager, List<WeLove> list_foods_we_love) {
        this.view = view;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Setting.getInstance().setItemWidth(food_we_love_item_cardView, 3.1);
        TextViewPlus text = holder.itemView.findViewById(R.id.food_we_love_tv);
            ...
            call.enqueue(new retrofit2.Callback<ir.ac.kntu.Entity.Food>() {
                ...
                public void onResponse(Call<ir.ac.kntu.Entity.Food> call, Response<ir.ac.kntu.Entity.Food> response) {
                    if (response.body() != null) {
                        ...
                        Helper_Log.errorLog(Adapter_FoodWeLoveFood.class);
                }

                @Override
                public void onFailure(Call<ir.ac.kntu.Entity.Food> call, Throwable t) {
                    Helper_Log.errorLog(t, Adapter_FoodWeLoveFood.class);
                }
            });
        });

        wholeItem.setOnClickListener(v -> {
