...
public class Constants {
    ...
    public static final String _KEY_RESTAURANT_SELECTION_QR_CODE = "_key_restaurant_selection_qr_code";
    public static final String _KEY_APP_MAIN_COLOR = "_key_app_main_color";
    public static final String ABAN_WEBSITE = "https://aban.dev/kntu_project";
